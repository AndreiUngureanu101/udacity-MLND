...
def _get_train_data_loader(batch_size, training_dir, mode = 'Class'):
    ...
    if (mode == 'Class'):
        ...
        train_data = pd.read_csv(os.path.join(training_dir, "train_all_categories.csv"), header=None, names=None)
        train_y = torch.from_numpy(train_data.iloc[:,0:4].to_numpy(dtype = 'float32'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type=int, default=3, metavar='N',
                       help='input features size for training (default: 3)')
    parser.add_argument('--hidden_dim', type=int, default=20, metavar='N',
                       help='hidden dimmensions size for training (default: 20)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='N',
                       help='output dimmension size for training (default: 1)')
    ...
    if args.output_dim == 1:
        ...
        train_loader = _get_train_data_loader(args.batch_size, args.data_dir, mode = 'Category')        
